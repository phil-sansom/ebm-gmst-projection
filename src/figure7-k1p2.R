...
width  = (210/25.4 - 2)/2
height = width/sqrt(2)
pdf("./fig/figure7-k1p2.pdf", width = width, height = height, pointsize = 8)
...
lines(2020:2100, apply(k1p2.sims, 1, mean), lwd = 2, col = 4)
lines(2020:2100, apply(k1p2.sims, 1, quantile, probs = 0.05), col = 4)
lines(2020:2100, apply(k1p2.sims, 1, quantile, probs = 0.95), col = 4)

legend("topleft", legend = c("IPCC method",expression(paste(kappa," = 1.0")),
