...
pdf("./fig/figure8-k1p2.pdf", width = width, height = height, pointsize = 8 )
...
lines(2020:2100, k1p2.exceed.20, lwd = 2, col = 4)

legend("bottomright", legend = c("IPCC method",expression(paste(kappa," = 1.0")),
...
lines(2020:2100, k1p2.exceed.15, lwd = 2, col = 4)
