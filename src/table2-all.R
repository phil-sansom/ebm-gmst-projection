...
models = c("ACCESS1-0","ACCESS1-3","BCC-CSM1.1","BCC-CSM1.1(m)","BNU-ESM",
           "CanESM2","CCSM4","CNRM-CM5","CSIRO-Mk3.6.0","FGOALS-s2",
           "GFDL-CM3","GFDL-ESM2G","GFDL-ESM2M","GISS-E2-R","HadGEM2-ES",
           "IPSL-CM5A-LR","IPSL-CM5A-MR","IPSL-CM5B-LR","MIROC-ESM","MIROC5",
...
write.table(pars, "./tab/table2-all.txt", quote = FALSE, sep = " & ", 
            col.names = FALSE)
